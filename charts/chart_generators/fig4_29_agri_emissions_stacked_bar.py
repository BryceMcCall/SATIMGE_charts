# charts/chart_generators/fig4_29_agri_emissions_stacked_bar.py
#
# Agriculture — Emissions by fuel (CO2-eq, Mt), stacked by year (2024–2035)
...
#
# CLI:
#   python charts/chart_generators/fig4_29_agri_emissions_stacked_bar.py
...
# Stack order (bottom → top) — matches your screenshot: Coal, HFO, Diesel, Kerosene
STACK_ORDER = ["Coal", "HFO", "Diesel", "Kerosene"]
...
def generate_fig4_29_agri_emissions_stacked_bar(df: pd.DataFrame, output_dir: str) -> None:
    """
    Build the stacked yearly bars (single panel) for agriculture emissions by fuel.
    """
    print("generating figure 4.29: Agriculture emissions by fuel (stacked, 2024–2035)")
    ...
    base_name = "fig4_29_agri_emissions_stacked_bar"
...
if __name__ == "__main__":
    ...
    data_path = project_root / "data" / "processed" / "4_29_agri_emissions.csv"
    ...
    out = project_root / "outputs" / "charts_and_data" / "fig4_29_agri_emissions_stacked_bar"
    out.mkdir(parents=True, exist_ok=True)
    generate_fig4_29_agri_emissions_stacked_bar(df, str(out))
